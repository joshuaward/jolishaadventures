export const benefits = [
  ...
  },
  {
    ...
    text: "Seceda's ridgeline, Lago di Carezza's emerald mirror, two nights at Hotel Schmuckhof in Chiusa, and those legendary donuts at Rifugio Friedrich August. Enough Dolomites to feel them — then Venice waits, and after Venice, Croatia.",
  },
  {
...
export const destinations = [
  ...
  },
  {
    ...
    lead: "Sunday we leave the lake and take the great alpine route north — dipping into Switzerland past glacial lakes, then back into Italy through the mountain passes to Chiusa, where we settle in at Hotel Schmuckhof. This is the last long drive of the trip. After Venice, we're on planes and ferries. Make it count.",
    highlights: [
      'The Swiss alpine pass — windows down, phones away',
      'Arrival in Chiusa — Hotel Schmuckhof as our base in the Dolomites',
  ...
  },
  {
    ...
    lead: "Two days in the peaks before Venice calls. Seceda's ridgeline when the morning light hits the rock faces, Lago di Carezza's emerald water, two nights at Hotel Schmuckhof in Chiusa as our home base, and a stop at Rifugio Friedrich August for their legendary donuts. We move on Tuesday — but the Dolomites stay with you.",
    highlights: [
